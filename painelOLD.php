...
<body>
    <section class="site-content site-section-mini themed-background-muted border-bottom">
        <div class="container">
            <h2 class="site-heading h3 site-block">
                <div class="col-md-10">
                    <i class="fa fa-fw fa-user"></i> <strong>ÁREA DO ADMINISTRADOR</strong>
                </div>
                <div class="col-md-2">
                    <a href="https://site.disite.com.br/"><img src="public/img/disite_logo.png" width="125px"></a>
                </div>
            </h2>
        </div>
    </section>
    ...
    <?php 
        include 'back-end/view/painel.php';
    ?>
</body>
</html>