...
<body>
    <section class="site-content site-section-mini themed-background-muted border-bottom">
        <div class="container">
            <h2 class="site-heading h3 site-block">
                <div class="col-md-10">
                    <i class="fa fa-fw fa-chevron-right"></i> <strong>Quase lá... - Tudo ao seu agrado?</strong>
                </div>
                <div class="col-md-2">
    ...
    include 'back-end/controller/tela6Controller.php';
    include 'back-end/controller/telaRevisaoController.php';
    include_once 'back-end/view/telaRevisao.php';
    ?>
</body>
</html>