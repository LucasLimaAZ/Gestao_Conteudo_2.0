	...
	<div class="container" >
		<div class="cabeçalho" style="background-color:#fff;">
			<h2 class="site-heading h3 site-block" >
                <div class="col-md-10">
                    <i class="fa fa-fw fa-chevron-right"></i> <strong>Passo 3 - Monte seu slider...</strong>
                </div>
                <div class="col-md-2">
				...
				<?php endforeach;?>
					...
					<div class="escolha">
						<form action="tela3.php" method="post">
							...
							<a href="clienteUpload.php">
								<input type="button" action="clienteUpload.php" class="botaoModelos" value="Já tenho minha imagem.">
							</a>
						</form>	
					</div>				
				</div>
